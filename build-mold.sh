...
declare_arch_info() {
  if [[ "$COMPILER_TYPE" == "gnu" ]]; then
    ...
    declare -gA ARCH_INFO=(
      [x86_64]="x86_64-unknown-linux-uclibc:x86_64-unknown-linux-uclibc.tar.xz:x86_64"
      [x86]="i686-unknown-linux-uclibc:i686-unknown-linux-uclibc.tar.xz:i686"
      [aarch64]="aarch64-unknown-linux-uclibc:aarch64-unknown-linux-uclibc.tar.xz:aarch64"
      [armv7]="armv7-unknown-linux-uclibcgnueabihf:armv7-unknown-linux-uclibcgnueabihf.tar.xz:armv7"
      [armhf]="arm-unknown-linux-uclibcgnueabihf:arm-unknown-linux-uclibcgnueabihf.tar.xz:armhf"
...
show_help() {
    ...
    echo -e "  ${NEONGREEN}--uClibc${NC}             Use uClibc toolchains"
